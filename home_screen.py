...
#     def on_search_by_body_no(body_no_entry):
#         # """Handles search by body number, prints valid integer input."""
#      body_no = body_no_entry.get()
#      if body_no.isdigit():  # Validate if the input is a valid integer
#         print(f"Searching for body number: {int(body_no)}")  
#         # In a real application, you'd perform the search logic here
#      else:
#           print("Invalid body number. Please enter an integer.")
...
#     search_by_body_no_button = tk.Button(main_frame, text="Search By Body No.", width=button_width, font=custom_font,command=lambda: on_search_by_body_no(body_no_entry))
