...
# Dynamically get paths using get_resource_path function
gear_file_path = get_resource_path('D:/project/import/import_gear.xlsx' )
box_file_path = get_resource_path('D:/project/import/import_box.xlsx' )
output_file_path = get_resource_path('C:/project/temp/gear_data.csv' )
